...
### 출력 
 ...
 이 문제를 보았을 때, 범위 내에서 최소의 값을 찾으라고 했기 때문에 parametic search를 사용해야겠다고 생각했다.
 
 1. 먼저 색종이를 덮을 때 아랫변에 붙여야 한다고 했으므로, 색종이의 최소 높이는 잘못 칠한 사각형의 높이의 최댓값과 같다.
 2. 잘못칠한 사각형의 x좌표만 가지고 특정길이의 색종이로 덮을 수 있는지 판단하면 된다.
